        ...
        <AppBar color="secondary" position="static" style={{zIndex: 2, position: "relative"}}>
            <Toolbar className="container">
                <Grid container alignItems="center">
                    <Grid item xs={2}> <Link color="primary" style={{color: "white"}} underline="none"> <Typography onClick={clickHome} className="title" variant="h5"> {pad ? "YC" : "YoutuberCritics"} </Typography> </Link> </Grid>
